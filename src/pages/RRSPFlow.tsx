...
const rrspOptions: { value: RRSPWithdrawalType; label: string; badge?: string }[] = [
  { value: 'deregistration', label: 'Deregistration', badge: 'Taxable' },
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-md text-center px-6">
            ...
            <p className="text-base text-qt-secondary leading-6 mb-2">
              Your {isHBP ? "Home Buyer's Plan" : isLLP ? 'Lifelong Learning Plan' : isOvercontribution ? 'overcontribution' : 'RRSP deregistration'} withdrawal request has been submitted.
            </p>
